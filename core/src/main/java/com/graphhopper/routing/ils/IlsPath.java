...
/**
 * Path object returned by {@link Route#getPath(Graph, Weighting, Weighting, int, int)} . This classes accepts a
 * weighting for scoring edges of the graph and adds to the total score of the path when
 * {@link #processEdge(int, int, int)} is called.
 */
public class IlsPath extends Path {
    ...
    IlsPath(Graph graph, Weighting costWeighting, Weighting scoreWeighting) {
